...
public class C2BPaymentConfirmationRequest
{
    ...
    public C2BPaymentConfirmationRequest(string billRefNumber, string transType, string transId, string transTime, decimal transAmount, string businessShortCode, string msisdn, KYCInfo[] kycInfos)
    {
