...
{
    public override string Name => "Awash Bank";

    public override string Description => "Awash Bank Payment Gateway";
    ...
    {
        services.AddAwashClient(configuration);
        return services;
    }
